...
<html lang="en">
<head>
    <title>Search: <?php echo htmlspecialchars($q); ?> - CNN Clone</title>
...
<body>
    <header>
        <h1>CNN News</h1>
        <form id="searchForm">
            <input type="text" id="search" placeholder="Search articles..." value="<?php echo htmlspecialchars($q); ?>">
    ...
    <section>
        ...
        <div class="article-container">
            <?php
            $sql = "SELECT id, title, summary, image_url FROM articles WHERE title LIKE '%$q%' OR summary LIKE '%$q%' OR content LIKE '%$q%'";
            $result = $conn->query($sql);
